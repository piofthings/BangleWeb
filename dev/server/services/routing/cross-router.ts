...
export class CrossRouter extends EventEmitter {
    ...
    public registerRoute = (currentRoute: CrossRoute) => {
        ...
        this.router.addRoute(currentRoute.route, (req: express.Request, res: express.Response, next: express.NextFunction, params: any) => {
            try {
    ...
    public route = (req: any, res: express.Response, next: express.NextFunction) => {
        this.nxt = next;
